...
Since Apple is completely incompetent (likely due to fear of legal repercussions if they acknowledge this) to fix this years old major issue (I have personally reported this multiple times), we are forced to work around the issue by using 3rd party tools.
